  ...
  return (
    ...
    <div ref={wrapperRef}>
      <button
        ...
        type="button"
        onClick={toggle}
        aria-label={signedIn ? `Account: signed in as ${account.email}` : 'Account: sign in to sync'}
        aria-expanded={open}
        aria-controls={panelId}
        className={[
          'grid h-11 w-11 touch-manipulation place-items-center rounded-full border transition active:scale-90',
